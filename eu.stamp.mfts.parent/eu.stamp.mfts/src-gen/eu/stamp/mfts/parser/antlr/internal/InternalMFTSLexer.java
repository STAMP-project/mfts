...
public class InternalMFTSLexer extends Lexer {
    ...
    public final void mT__18() throws RecognitionException {
        try {
            int _type = T__18;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMFTS.g:13:7: ( 'sends' )
            // InternalMFTS.g:13:9: 'sends'
            {
            match("sends"); 
    ...
    public final void mT__20() throws RecognitionException {
        try {
            int _type = T__20;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMFTS.g:15:7: ( 'receives' )
            // InternalMFTS.g:15:9: 'receives'
            {
            match("receives"); 
    ...
    public final void mT__39() throws RecognitionException {
        try {
            int _type = T__39;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMFTS.g:34:7: ( 'true' )
            // InternalMFTS.g:34:9: 'true'
            {
            match("true"); 
    ...
    public final void mT__40() throws RecognitionException {
        try {
            int _type = T__40;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMFTS.g:35:7: ( 'false' )
            // InternalMFTS.g:35:9: 'false'
            {
            match("false"); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMFTS.g:1668:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalMFTS.g:1668:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalMFTS.g:1668:11: ( '^' )?
            int alt1=2;
            ...
            // InternalMFTS.g:1668:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_BYTE() throws RecognitionException {
        try {
            int _type = RULE_BYTE;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMFTS.g:1670:11: ( '0x' ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )
            // InternalMFTS.g:1670:13: '0x' ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' )
            {
            match("0x"); 
    ...
    public final void mRULE_CHAR() throws RecognitionException {
        try {
            int _type = RULE_CHAR;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMFTS.g:1672:11: ( '\\'' ( '\\\\0' | '\\\\t' | '\\\\n' | '\\\\r' | ' ' .. '&' | '\\\\\\'' | '(' .. '[' | '\\\\\\\\' | ']' .. '~' ) '\\'' )
            // InternalMFTS.g:1672:13: '\\'' ( '\\\\0' | '\\\\t' | '\\\\n' | '\\\\r' | ' ' .. '&' | '\\\\\\'' | '(' .. '[' | '\\\\\\\\' | ']' .. '~' ) '\\''
            {
            match('\''); 
            // InternalMFTS.g:1672:18: ( '\\\\0' | '\\\\t' | '\\\\n' | '\\\\r' | ' ' .. '&' | '\\\\\\'' | '(' .. '[' | '\\\\\\\\' | ']' .. '~' )
            int alt3=9;
            alt3 = dfa3.predict(input);
            switch (alt3) {
                case 1 :
                    // InternalMFTS.g:1672:19: '\\\\0'
                    {
                    match("\\0"); 
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMFTS.g:1674:10: ( ( '0' .. '9' )+ )
            // InternalMFTS.g:1674:12: ( '0' .. '9' )+
            {
            // InternalMFTS.g:1674:12: ( '0' .. '9' )+
            int cnt4=0;
            loop4:
    ...
    public final void mRULE_FLOAT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMFTS.g:1676:12: ( ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | '.' ( '0' .. '9' )+ ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | ( '0' .. '9' )+ ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ ) )
            // InternalMFTS.g:1676:14: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | '.' ( '0' .. '9' )+ ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | ( '0' .. '9' )+ ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )
            {
            // InternalMFTS.g:1676:14: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | '.' ( '0' .. '9' )+ ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | ( '0' .. '9' )+ ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )
            int alt17=3;
            ...
            switch (alt17) {
                case 1 :
                    // InternalMFTS.g:1676:15: ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )?
                    {
                    // InternalMFTS.g:1676:15: ( '0' .. '9' )+
                    int cnt5=0;
                    loop5:
                    do {
                        int alt5=2;
                    ...
                    // InternalMFTS.g:1676:43: ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )?
                    int alt9=2;
                    ...
                    switch (alt9) {
                        case 1 :
                            // InternalMFTS.g:1676:44: ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
                            {
                    ...
                    break;
                case 2 :
                    // InternalMFTS.g:1676:79: '.' ( '0' .. '9' )+ ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )?
                    {
                    match('.'); 
                    // InternalMFTS.g:1676:83: ( '0' .. '9' )+
                    int cnt10=0;
                    loop10:
                    do {
                        int alt10=2;
                    ...
                    // InternalMFTS.g:1676:95: ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )?
                    int alt13=2;
                    ...
                    switch (alt13) {
                        case 1 :
                            // InternalMFTS.g:1676:96: ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
                            {
                            if ( input.LA(1)=='E'||input.LA(1)=='e' ) {
                                input.consume();
                    ...
                    break;
                case 3 :
                    // InternalMFTS.g:1676:131: ( '0' .. '9' )+ ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
                    {
                    // InternalMFTS.g:1676:131: ( '0' .. '9' )+
                    int cnt14=0;
                    loop14:
                    do {
                        int alt14=2;
    ...
    public final void mRULE_ANNOTATION_ID() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMFTS.g:1678:20: ( '@' ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalMFTS.g:1678:22: '@' ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            match('@'); 
            if ( (input.LA(1)>='A' && input.LA(1)<='Z')||input.LA(1)=='_'||(input.LA(1)>='a' && input.LA(1)<='z') ) {
                input.consume();
            ...
            // InternalMFTS.g:1678:50: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop18:
            do {
                int alt18=2;
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMFTS.g:1680:13: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' )
            // InternalMFTS.g:1680:15: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
            {
            match('\"'); 
            // InternalMFTS.g:1680:19: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
            loop19:
            do {
                int alt19=3;
    ...
    public final void mRULE_EXTERN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMFTS.g:1682:13: ( '`' ( '\\\\' . | ~ ( ( '\\\\' | '`' ) ) )* '`' )
            // InternalMFTS.g:1682:15: '`' ( '\\\\' . | ~ ( ( '\\\\' | '`' ) ) )* '`'
            {
            match('`'); 
            // InternalMFTS.g:1682:19: ( '\\\\' . | ~ ( ( '\\\\' | '`' ) ) )*
            loop20:
            do {
                int alt20=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMFTS.g:1684:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalMFTS.g:1684:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalMFTS.g:1684:24: ( options {greedy=false; } : . )*
            loop21:
            do {
                int alt21=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMFTS.g:1686:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalMFTS.g:1686:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalMFTS.g:1686:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop22:
            do {
                int alt22=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMFTS.g:1688:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalMFTS.g:1688:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalMFTS.g:1688:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt25=0;
            loop25:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMFTS.g:1690:16: ( . )
            // InternalMFTS.g:1690:18: .
            {
            matchAny(); 
    ...
    class DFA17 extends DFA {
        ...
        public String getDescription() {
            return "1676:14: ( ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | '.' ( '0' .. '9' )+ ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )? | ( '0' .. '9' )+ ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )";
        }
    }
    static final String DFA26_eotS =
        "\1\uffff\1\43\1\uffff\1\43\1\uffff\1\43\1\uffff\1\43\3\uffff\3\43\1\uffff\1\43\1\uffff\1\43\3\uffff\1\43\1\41\1\uffff\1\73\1\41\1\73\5\41\2\uffff\1\43\2\uffff\1\43\1\uffff\1\43\1\uffff\1\43\3\uffff\5\43\1\uffff\1\43\1\uffff\1\43\3\uffff\1\43\3\uffff\1\73\7\uffff\7\43\1\131\6\43\1\141\3\43\1\145\1\146\1\uffff\1\43\1\150\4\43\1\155\1\uffff\3\43\2\uffff\1\43\1\uffff\2\43\1\164\1\43\1\uffff\3\43\1\171\1\172\1\173\1\uffff\1\43\1\175\1\43\1\177\3\uffff\1\43\1\uffff\1\u0081\1\uffff\1\u0082\2\uffff";
    static final String DFA26_eofS =
        "\u0083\uffff";
    static final String DFA26_minS =
        "\1\0\1\156\1\uffff\1\145\1\uffff\1\145\1\uffff\1\145\3\uffff\1\145\2\141\1\uffff\1\170\1\uffff\1\163\3\uffff\1\141\1\101\1\uffff\1\56\1\40\1\56\1\60\1\101\2\0\1\52\2\uffff\1\164\2\uffff\1\156\1\uffff\1\143\1\uffff\1\163\3\uffff\1\163\1\165\1\162\1\164\1\151\1\uffff\1\160\1\uffff\1\163\3\uffff\1\154\3\uffff\1\56\7\uffff\1\145\1\144\1\166\1\145\1\163\1\164\1\145\1\60\1\150\1\164\2\145\1\163\1\162\1\60\2\151\1\141\2\60\1\uffff\1\151\1\60\1\143\1\162\1\145\1\146\1\60\1\uffff\1\143\1\166\1\147\2\uffff\1\156\1\uffff\2\164\1\60\1\141\1\uffff\3\145\3\60\1\uffff\1\143\1\60\1\163\1\60\3\uffff\1\145\1\uffff\1\60\1\uffff\1\60\2\uffff";
    static final String DFA26_maxS =
        "\1\uffff\1\156\1\uffff\1\145\1\uffff\1\145\1\uffff\1\145\3\uffff\1\162\1\141\1\151\1\uffff\1\170\1\uffff\1\163\3\uffff\1\141\1\172\1\uffff\1\170\1\176\1\145\1\71\1\172\2\uffff\1\57\2\uffff\1\164\2\uffff\1\162\1\uffff\1\143\1\uffff\1\163\3\uffff\1\163\1\165\1\162\1\164\1\151\1\uffff\1\160\1\uffff\1\163\3\uffff\1\154\3\uffff\1\145\7\uffff\1\145\1\144\1\166\1\145\1\163\1\164\1\145\1\172\1\150\1\164\2\145\1\163\1\162\1\172\2\151\1\141\2\172\1\uffff\1\151\1\172\1\143\1\162\1\145\1\146\1\172\1\uffff\1\143\1\166\1\147\2\uffff\1\156\1\uffff\2\164\1\172\1\141\1\uffff\3\145\3\172\1\uffff\1\143\1\172\1\163\1\172\3\uffff\1\145\1\uffff\1\172\1\uffff\1\172\2\uffff";
    static final String DFA26_acceptS =
        "\2\uffff\1\2\1\uffff\1\4\1\uffff\1\6\1\uffff\1\10\1\11\1\13\3\uffff\1\21\1\uffff\1\23\1\uffff\1\25\1\26\1\27\2\uffff\1\32\10\uffff\1\44\1\45\1\uffff\1\32\1\2\1\uffff\1\4\1\uffff\1\6\1\uffff\1\10\1\11\1\13\5\uffff\1\21\1\uffff\1\23\1\uffff\1\25\1\26\1\27\1\uffff\1\33\1\35\1\36\1\uffff\1\34\1\37\1\40\1\41\1\42\1\43\1\44\24\uffff\1\15\7\uffff\1\20\3\uffff\1\14\1\30\1\uffff\1\17\4\uffff\1\3\6\uffff\1\31\4\uffff\1\16\1\22\1\24\1\uffff\1\12\1\uffff\1\7\1\uffff\1\5\1\1";
    static final String DFA26_specialS =
        "\1\0\34\uffff\1\2\1\1\144\uffff}>";
    static final String[] DFA26_transitionS = {
            "\11\41\2\40\2\41\1\40\22\41\1\40\1\16\1\35\3\41\1\24\1\31\1\10\1\11\2\41\1\4\1\41\1\33\1\37\1\30\11\32\1\12\4\41\1\20\1\34\32\27\1\22\1\41\1\23\1\26\1\27\1\36\1\21\3\27\1\17\1\25\2\27\1\1\3\27\1\7\2\27\1\14\1\27\1\5\1\3\1\13\2\27\1\15\3\27\1\2\1\41\1\6\uff82\41",
            "\1\42",
            "",
            "\1\45",
            "",
